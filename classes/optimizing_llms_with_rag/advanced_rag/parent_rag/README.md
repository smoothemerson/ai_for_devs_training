...
Este projeto contém código de exemplo para o desenvolvimento de LLM utilizando RAG de um projeto do LangChain envolvendo códigos escritos em Python. O objetivo é realizar o Parent RAG no documento PDF para responder ao usuário.
